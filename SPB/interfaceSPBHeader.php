...
<script>
	...
	function clickSync()
	{
			...
			var options = { 
				...
				url:       'http://nuansaelektronik.com/Nuansa1/SPB/insertSPBHeader.php'        // override for form's 'action' attribute 
	...
	function getContent()
	{
		...
		var options = { 
			...
			// other available options: 
			url:       'syncSPBHeader.php'         // override for form's 'action' attribute 
			//type:      type        // 'get' or 'post', override for form's 'method' attribute 
			//dataType:  null        // 'xml', 'script', or 'json' (expected server response type) 
			//clearForm: true        // clear all form fields after successful submit 
			//resetForm: true        // reset the form after successful submit 
...
<form name="frmSyncPOHeader" id="frmSyncPOHeader" method="post" enctype="multipart/form-data">
	...
	<? 
		if(file_get_contents("http://nuansaelektronik.com/Nuansa1/SPB/readDateSync.php?file=SPBHeader"))
		{
			$a = file_get_contents("http://nuansaelektronik.com/Nuansa1/SPB/readDateSync.php?file=SPBHeader");
